...
int trial_num = 78;
int support_num = 3; // 0: haptic table (always), 1: 0%, 2: 30%, 3: 50%
...
float support_level[5] = { 0.3, 0.0, 0.3, 0.5, 0.5 }; // fraction of max shoulder abduction loading (0-1)
const int max_support = 3; // support level index that represents the most load

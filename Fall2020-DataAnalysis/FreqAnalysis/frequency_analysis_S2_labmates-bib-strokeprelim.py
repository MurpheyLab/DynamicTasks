...
conditions = ['paretic','nonparetic']
group_label_read = ['A0','A1']
group_label = ['A0','A1']
...
for sub_plot in range(min_sub,min_sub+num_sub_plots):
    ...
    for group in range(0,len(conditions)):
        ...
        for subject_num in range(min_sub,min_sub+number_of_subjects): #iterate though subjects

            if (make_plot_each_sub==0) or (make_plot_each_sub==1 and sub_plot==subject_num):

                for freq in range(0,4):
                    if subject_num==101 and freq==2:
                        freq = 4
        ...
        if make_plots==1:
            ...
            ####################################################################
            ####################################################################
            title = 'Frequency Spectrum Plot: ' + conditions[group]
            ...
            if make_plot_each_sub==1:
                ...
                if sub_plot==101:
                    title = title + ', severe, different support levels'
                elif sub_plot==102:
                    title = title + ', mild, weightless'
                elif sub_plot==103:
                    if s103flag:
                        title = title + ', severe, tabletop'
                    else:
                        title = title + ', severe, 10% loading'
                    savename = 'Plots/IndividualSubjectPlots/Sub'+str(sub_plot)+'_xy_freq_'+group_label[group]+str(s103flag)+'.png'
            ...
            if make_plot_each_sub==1:
                ...
                if sub_plot==101:
                    ...
                    if s103flag:
                        ...
                        title = title + ', severe, 10% loading'
                    savename = 'Plots/IndividualSubjectPlots/Sub'+str(sub_plot)+'_mag_freq_'+group_label[group]+str(s103flag)+'.png'

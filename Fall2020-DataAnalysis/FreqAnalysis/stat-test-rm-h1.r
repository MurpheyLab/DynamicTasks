################################################################################
# H1 tests whether the ball frequency significantly affects the energy@resonance metric
...
data = subset(data, Force==group) #& Subject!='Subject6')
...
sink(paste(DIR,"Stats","Controls",paste("Energy",group,"h1.txt",sep="-"),sep="/"))

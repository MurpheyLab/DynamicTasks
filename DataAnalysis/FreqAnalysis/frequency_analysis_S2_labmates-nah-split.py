...
for sub_plot in range(2,1+num_iters):
                ...
                for k in range(1,14): #iterate through trials
                    try:
                        ...
                        if split_signal:
                            ...
                            A_Fmag_nails_i,frq = calculate_amplitude(w,y_nails,Fs,True)
                            A_Fx_nails_i,frq = calculate_amplitude(w,y_Fx_nails,Fs,True)
                            A_Fy_nails_i,frq = calculate_amplitude(w,y_Fy_nails,Fs,True)

                            A_Fmag_other_i,frq = calculate_amplitude(w,y_other,Fs,True)
                            A_Fx_other_i,frq = calculate_amplitude(w,y_Fx_other,Fs,True)
                            A_Fy_other_i,frq = calculate_amplitude(w,y_Fy_other,Fs,True)
    ...
    if make_plots==1:
        ...
        plot_num = 0
        l0 = ax_force[plot_num].plot([0.5, 0.5],[ymin, ymax_pend],linestyle=':',color='k', label="0.5Hz")
        if split_signal:
            l1 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx_nails[0,wi_0:w_len],linestyle=linestyles[1],color=colors[0],label="nail hammering"+frequencylabels[0])
            l2 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx_other[0,wi_0:w_len],linestyle=linestyles[0],color=colors[0],label="other movement"+frequencylabels[0])
            l3 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx_nails[1,wi_0:w_len],linestyle=linestyles[1],color=colors[1],label="nail hammering"+frequencylabels[1])
            l4 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx_other[1,wi_0:w_len],linestyle=linestyles[0],color=colors[1],label="other movement"+frequencylabels[1])
        else:
            l1 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx[0,wi_0:w_len],linestyle=linestyles[1],color=colors[0],label=(frequencylabels[0]))
            l2 = ax_force[plot_num].plot(w[wi_0:w_len],A_Fx[1,wi_0:w_len],linestyle=linestyles[1],color=colors[1],label=(frequencylabels[1]))
        ...
        if split_signal:
            for freq in range(0,2):
                ax_force[plot_num].plot(w[wi_0:w_len],A_Fy_nails[freq,wi_0:w_len],linestyle=linestyles[1],color=colors[freq],label="nail hammering"+frequencylabels[freq])
                ax_force[plot_num].plot(w[wi_0:w_len],A_Fy_other[freq,wi_0:w_len],linestyle=linestyles[0],color=colors[freq],label="other movement"+frequencylabels[freq])
        else:
            for freq in range(0,2):
                ax_force[plot_num].plot(w[wi_0:w_len],A_Fy[freq,wi_0:w_len],linestyle=linestyles[1],color=colors[freq],label=(frequencylabels[freq]))
        ...
        line_labels = ["0.5Hz", "nail hammering\n& "+frequencylabels[0],"other movement\n& "+frequencylabels[0],"nail hammering\n& "+frequencylabels[1],"other movement\n& "+frequencylabels[1]]
        fig_force.legend([l0,l1,l2,l3,l4],labels=line_labels,loc="center right", fontsize=9) #,labels=line_labels

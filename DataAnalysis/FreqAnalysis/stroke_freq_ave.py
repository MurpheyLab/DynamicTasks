...
DIR = "E:\Research\DowntownWork\DowntownData\Stroke2021\\" #set directory where data is mounted Ola- "/media/ola/Elements/R01prelim" Milli -"Z:"

file_metrics = "stroke-freq-averages.csv"
                            ...
                            if len(df) > w_len:
                                ...
                                if use_trial:
                                    ...
                                    if save_values:
                                        ...
                                        with open(file_metrics,'a', newline="") as csvfile:
                                            testwriter = csv.writer(csvfile,delimiter=',')
            ...
            if save_values:
                ...
                for freq in range(0,len(frequencylabels)):
                    for i in range(12):
                        ...
                        with open(file_metrics_all,'a', newline="") as csvfile:
                            testwriter = csv.writer(csvfile,delimiter=',')
                            testwriter.writerow(row)
            ...
            if make_plots:
                for freq in range(0,len(frequencylabels)):
                    ...
                    if save_values:
                        ...
                        with open(file_metrics_selected,'a', newline="") as csvfile:
                            testwriter = csv.writer(csvfile,delimiter=',')
                            testwriter.writerow(row)

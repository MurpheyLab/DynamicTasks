...
def add_labels(ax,x1,x2,y,name,text_buffer):
    ...
    for i in range(len(x1)):
        ...
        ax.text(text_x, text_height,name[i],horizontalalignment='center', fontname="sans-serif", fontsize=9)
...
def make_stackedbar(data1,data2,title,xlabel,ylabel,labels,colors,alphas,figure_size):
    ...
    #figure legend
    L = fig.legend([p1[0], p2[0]], ['Lives', 'Treasures'],ncol=2, fontsize=9,loc='upper center',
...
def make_boxplot(data,title,xlabel,ylabel,labels,box_colors,box_alpha,figure_size):
    ...
    ax.set_title(title, fontsize=9, fontweight='bold',fontname="sans-serif")
